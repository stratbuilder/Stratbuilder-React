...
const Home = (props) => {
  return (
    <div className="home-container">
      <Helmet>
        <title>Stratbuilder</title>
        <meta property="og:title" content="Stratbuilder" />
      </Helmet>
      <div className="home-header">
        ...
        >
          <span className="logo">STRATBUILDER</span>
          <div data-thq="thq-navbar-nav" className="home-desktop-menu">
            <nav className="home-links">
              <span className="bodySmall">Home</span>
              <span className="home-nav22 bodySmall">How It Works</span>
              <span className="home-nav32 bodySmall">Benefits</span>
          ...
          >
            <div className="home-nav">
              ...
              <nav className="home-links1">
                ...
                <span className="home-nav321 bodySmall">Benefits</span>
        ...
        <div className="heroContainer home-hero1">
          <div className="home-container01">
            <h1 className="home-hero-heading heading1">
              Empower Your Forex Trading with Stratbuilder
            </h1>
            <span className="home-hero-sub-heading bodyLarge">
              <span>
                <span>
                  <span>Your Automated Trading Assistant</span>
                  <span>
                    <span
            ...
            <div className="home-btn-group">
              <button className="buttonFilled">Start Trading Now</button>
          ...
          <div className="home-features1">
            <div className="home-container02">
              ...
              <h2 className="home-features-heading heading2">
                Empower Your Trading with Stratbuilder
              </h2>
              <span className="home-features-sub-heading bodyLarge">
                <span>
                  <span>
                    <span>
                      Discover the key features that make Stratbuilder the
                      ultimate forex trading assistant
                    </span>
                    <span>
                      <span
                        dangerouslySetInnerHTML={{
            ...
            <div className="home-container03">
              <FeatureCard
                ...
                subHeading="Stratbuilder executes trades automatically based on predefined strategies"
              ></FeatureCard>
              <FeatureCard
                heading="Risk Management"
                subHeading="Advanced risk management tools to protect your investment and maximize returns"
              ></FeatureCard>
              <FeatureCard
                heading="Real-Time Analysis"
                subHeading="Constant monitoring of market trends and analysis to make informed trading decisions"
              ></FeatureCard>
              <FeatureCard
                heading="Customizable Strategies"
                subHeading="Tailor-made trading strategies to suit your risk tolerance and investment goals"
              ></FeatureCard>
            </div>
          </div>
        </div>
        ...
        <div className="pricingContainer">
          <div className="home-container04">
            ...
            <span className="home-pricing-sub-heading bodyLarge">
              <span>
                <span>
                  Take your forex trading to the next level with our flexible
                  pricing options
                </span>
              </span>
            </span>
          ...
          <div className="home-container05">
            <div className="freePricingCard home-pricing-card">
              ...
              <div className="home-container08">
                <div className="home-container09">
                  ...
                  <span className="bodySmall">
                    Access to automated trading assistant
                  </span>
                </div>
                <div className="home-container10">
                  <span className="home-text41">✔</span>
                  <span className="bodySmall">Real-time market analysis</span>
                </div>
                <div className="home-container11">
                  <span className="home-text42">✔</span>
                  <span className="bodySmall">
                    Limited number of trades per month
                  </span>
                </div>
            ...
            <div className="basicPricingCard home-pricing-card1">
              ...
              <div className="home-container15">
                ...
                <div className="home-container17">
                  ...
                  <span className="bodySmall">Unlimited trades per month</span>
                </div>
            ...
            <div className="proPricingCard home-pricing-card2">
              <div className="home-container21">
                ...
                <span className="bodySmall">
                  Unlock the full potential of automated trading
                </span>
              </div>
      ...
      <div className="home-banner">
        <div className="bannerContainer home-banner1">
          <h1 className="home-banner-heading heading2">
            Automate Your Forex Trading with Confidence
          </h1>
          <span className="home-banner-sub-heading bodySmall">
            <span>
              <span>
                <span>
                  Stratbuilder is your all-in-one solution for automated forex
                  trading. Our cutting-edge technology and advanced algorithms
                  empower you to trade with precision and efficiency. Say
                  goodbye to manual trading and let Stratbuilder handle the
        ...
        <div className="faqContainer">
          <div className="home-faq1">
            ...
            <div className="home-container30">
              <Question1
                answer="Stratbuilder is a fully automated forex trading assistant that helps users execute trades based on predefined strategies."
                question="What is Stratbuilder?"
              ></Question1>
              <Question1
                answer="Stratbuilder uses advanced algorithms to analyze market data and execute trades automatically according to user-defined parameters."
                question="How does Stratbuilder work?"
              ></Question1>
              <Question1
                answer="Yes, Stratbuilder is designed to be user-friendly and can be used by both beginners and experienced traders."
                question="Is Stratbuilder suitable for beginners?"
              ></Question1>
              <Question1
                answer="Yes, users can customize their trading strategies and set specific parameters for Stratbuilder to follow."
                question="Can I customize my trading strategies with Stratbuilder?"
              ></Question1>
              <Question1
                answer="Stratbuilder prioritizes security and uses encryption protocols to ensure the safety of user investments."
                question="Is my investment safe with Stratbuilder?"
              ></Question1>
            </div>
          </div>
        </div>
        ...
        <footer className="footerContainer home-footer1">
          <div className="home-container31">
            ...
            <nav className="home-nav1">
              ...
              <span className="home-nav322 bodySmall">Benefits</span>
